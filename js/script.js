/**
 * @author Bhavesh Prajapati <bhaveshpp11@gmail.com>
 */
(function ($) {
    "use strict";
...
$(document).ready(function(){
    var myAudioControll = $("#audio-controll");
    var myAudio = document.getElementById("my_audio");
    console.log('Shaadi me zaroor aana');
    $(".audio-controll").on('click', function(){
        if (myAudioControll.hasClass('fa-pause')) {
            myAudio.pause();
            myAudioControll.removeClass('fa-pause');
            myAudioControll.addClass('fa-play');
        } else if (myAudioControll.hasClass('fa-play')) {
            myAudio.play();
            myAudioControll.removeClass('fa-play');
            myAudioControll.addClass('fa-pause');
        }
    });
});

// Set the date we're counting down to
var countDownDate = new Date("Nov 17, 2022 20:00:00").getTime();
...
console.log('%cYour presence is requested!%c\n\nRegards: Bhavesh Prajapati', styles1, styles2);
